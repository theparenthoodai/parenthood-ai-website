...
NAV = """  <div class="site-nav">
    ...
    <div class="nav-links" style="display:flex;align-items:center;gap:30px">
      <a class="navlink" href="{root}guides.html">Free guides</a>
...
FOOTER = """  <div class="site-footer">
    <div class="footer-inner">
      <div class="footer-cols">
        ...
        <div class="footer-col"><span class="wm" style="color:var(--sand-400);margin-bottom:4px">EXPLORE</span><a href="{root}guides.html" style="color:inherit">Free guides</a><a href="{root_or_dot}" style="color:inherit">Blog</a><a href="{root}about.html" style="color:inherit">About</a></div>
